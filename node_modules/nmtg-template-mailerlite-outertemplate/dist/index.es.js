...
const customError$1 = new Errors$1('link');
...
function strong (content) {
  const error = new Errors$1('strong');
...
const customError = new Errors$1('paragraph');
...
const error$2 = new Errors('bodyComponent');
...
const error$1 = new Errors('supportComponent');
...
const createSupportTextTop = (href, id, text) => {
  if (href == '') {
    error$1.add('href textTop');
  }
  if (id == '') {
    error$1.add('id textTop');
  }
  if (text == '') {
    error$1.add('text textTop');
  }
...
const createSupportTextBottom = (href, id, text, textMail) => {
  if (href == '') {
    error$1.add('href textBottom');
  }
  if (id == '') {
    error$1.add('id textBottom');
  }
  if (text == '') {
    error$1.add('text textBottom');
  }
...
function supportComponent (data) {
...
function contentMainTableWrap$1 (params) {
...
export { amazonFreshMainBlock as amazonFreshBlock, blobHead, bodyComponent, bodyStyle, contentMainTableWrap$1 as contentMainTableWrap, createUnsubscribe, font1, font2, footerComponent, headComponent, ifStyle, mediaStyle, meta, post_tags, pre_tags, style, style2, supportComponent };
