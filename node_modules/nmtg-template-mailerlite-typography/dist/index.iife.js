var newsletterLayoutsTypographyPlainJS = (function (exports) {
  ...
  const headingMainBlock = (hrefTitle, idTitle, textTitle) => {
    ...
    return linkComponent$1({ content: textTitle, attributesStr });
  };
  ...
  const customError$1 = new Errors('paragraph');
  ...
  exports.buttonComponentOld = buttonComponentOld;
  exports.heading = headingMainBlock;
